$(document).ready(function() {
    ...
    function buildLocationList(data) {
      ...
      for (i = 0; i < data.features.length; i++) {
        ...
        var imgHtml = listing.appendChild(img);
        imgHtml.className = 'img';

        var mainDetail = listing.appendChild(document.createElement('div'));
        mainDetail.className = 'card__info';
...
//        link.dataPosition = i;
        ...
        details.className = 'card__info-desc';
